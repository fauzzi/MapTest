...
public class DistanceCalculationActivity extends ToolbarActivity implements
  OnMapReadyCallback,
  ...
  @BindView(R.id.buttonSetFrom)
  Button buttonSetFrom;

  @BindView(R.id.buttonSetTo)
  Button buttonSetTo;

  @BindView(R.id.buttonCalcDistance)
  Button buttonCalcDistance;


  @Override
  protected int getContentViewResource() {
    return R.layout.activity_distance_calculation;
  }
...
//    AppIndex.AppIndexApi.end(googleApiClient, viewAction);
  ...
  public String makeURL(double sourcelat, double sourcelog, double destlat, double destlog) {
    ...
    urlString.append("&key=AIzaSyB7_YrdRwaIxAjWmI9XRkazolQzkOSPo-Y");
